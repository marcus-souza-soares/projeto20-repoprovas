...
import { createNote, getNotes, getUniqueNote, deleteNote, } from "../controllers/notesController.js";
...
noteRouter.post("/insert/note", authMiddleware, schemaValidate(noteSchema), createNote);
